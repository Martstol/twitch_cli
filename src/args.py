...
def get_parser():
    parser = argparse.ArgumentParser(prog="twitch_cli", usage="%(prog)s [options]", description="Command-line interface for accessing twitch streams from the command-line")
    parser.add_argument("-t", "--top", type=int, nargs="?", metavar="N", const=10, default=None, help="List games by number of viewers")
    parser.add_argument("-g", "--game", help="List the top streamers for the given game. Does accept names with spaces")
