...
def get_parser():
    ...
    parser.add_argument("-g", "--game", help="List the top streamers for the given game")
    ...
    parser.add_argument("-f", "--follows", help="List streamers the logged in user is following if they are streaming")
